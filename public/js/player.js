class Player {
  ...
  createGraphics() {
    ...
    this.sprite.drawCircle(0, 0, this.playerRadius);
    ...
    this.weapon.scale.x = this.weapon.scale.y = this.weaponScale;
    this.weapon.pivot = new PIXI.Point(-30, -80);
